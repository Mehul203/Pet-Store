...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="product-form">
			...
			<div class="form-group">
				<label for="product_name" class="control-label"required="required">Product Name</label>
                <textarea name="product_name" id="" cols="30" rows="2" class="form-control form no-resize"required="required"><?php echo isset($product_name) ? $product_name : ''; ?></textarea>
			</div>
            <div class="form-group">
				<label for="description" class="control-label">Description</label>
                <textarea name="description" id="" cols="30" rows="2" class="form-control form no-resize"required="required"><?php echo isset($description) ? $description : ''; ?></textarea>
			</div>
            <div class="form-group">
